...
//   const InputField = ({ label, name, type = "text", placeholder, icon: Icon, isRequired = false }) => (
...
//   const SocialInput = ({ platform, icon: Icon, placeholder }) => (
//     <div className="space-y-2">
//       <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
...
//             errors[platform.toLowerCase()] ? 'border-red-500' : 'border-gray-300'
//           }`}
//         />
//         <Icon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
//       </div>
//       {errors[platform.toLowerCase()] && (
//         <p className="text-red-500 text-sm">{errors[platform.toLowerCase()]}</p>
//       )}
//     </div>
//   );
