...
const HeroSectionManager = () => {
    ...
    const uploadImages = async () => {
        ...
        try {
            ...
            setImageUploadError(error.response?.data?.message || error.message || "Failed to upload images");
        } finally {
        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-xl">
                    ...
                    <h3 className="text-lg font-medium text-gray-600">No Hero Sections Found</h3>
                    <p className="text-gray-500 mt-1">Create your first hero section to get started</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {heroSections.map((hero) => (
                        <div key={hero.id} className="bg-white rounded-xl border shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                            {/* Hero Image Preview */}
                            ...
                            {/* Hero Info */}
                            <div className="p-4">
                                <h3 className="font-semibold text-gray-800 truncate">{hero.title}</h3>
                                {hero.subtitle && (
                                    <p className="text-sm text-gray-600 mt-1 truncate">{hero.subtitle}</p>
                                )}
                                {hero.slogan && (
                                    <p className="text-xs text-blue-600 mt-1 italic truncate">"{hero.slogan}"</p>
                                )}
        ...
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-800">
                    {mode === "edit" ? `Edit Hero Section #${currentHero?.id}` : "Create Hero Section"}
                </h1>
            ...
            <div className="bg-white rounded-xl border shadow-sm p-6">
                <div className="space-y-8">
                    {/* Basic Information */}
                    <div>
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Hero Information</h2>
                        <div className="space-y-6">
                            <div>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50 transition-colors cursor-pointer mb-6">
                            ...
                            <label htmlFor="imageUpload" className="cursor-pointer block">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-700">Upload Images</h3>
                                        <p className="text-gray-500 mt-1">Click to browse or drag & drop</p>
    ...
    const renderView = () => (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-800">Hero Section Details</h1>
                <button
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                {formData.subtitle && (
                                    <p className="text-xl text-gray-600 mt-2">{formData.subtitle}</p>
                                )}
                                {formData.slogan && (
                                    <p className="text-lg text-blue-600 mt-3 italic">"{formData.slogan}"</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t">
                            <div className="space-y-2">
                                ...
                                <p className="text-gray-800">
                                    {formatDate(currentHero?.created_at)} at {formatTime(currentHero?.created_at)}
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-gray-800">
                                    {formatDate(currentHero?.updated_at)} at {formatTime(currentHero?.updated_at)}
                                </p>
                            </div>
                        </div>
